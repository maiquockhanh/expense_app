...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).companyId(DEFAULT_COMPANY_ID);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).companyId(UPDATED_COMPANY_ID);
        return company;
    }
    ...
    void putNewCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).companyId(UPDATED_COMPANY_ID);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.companyId(UPDATED_COMPANY_ID);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).companyId(UPDATED_COMPANY_ID);
