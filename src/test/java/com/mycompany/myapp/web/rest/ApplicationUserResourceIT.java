...
class ApplicationUserResourceIT {
    ...
    private static final Role DEFAULT_ROLE = Role.Administrator;
    private static final Role UPDATED_ROLE = Role.Approver;
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().role(DEFAULT_ROLE);
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().role(UPDATED_ROLE);
        return applicationUser;
    }
    ...
    void putNewApplicationUser() throws Exception {
        ...
        updatedApplicationUser.role(UPDATED_ROLE);
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.role(UPDATED_ROLE);
